...
def password_no_number():
    return JSONResponse(status_code=422, content={"message": "Password must contain at least one number"})

def password_no_upper():
    return JSONResponse(status_code=422, content={"message": "Password must contain at least one uppercase letter"})

def password_no_lower():
    return JSONResponse(status_code=422, content={"message": "Password must contain at least one lowercase letter"})

def password_no_special():
    return JSONResponse(status_code=422, content={"message": "Password must contain at least one special character"})
...
def username_not_alphanumeric():
    return JSONResponse(status_code=422, content={"message": "Username must be alphanumeric"})

def first_name_not_alphanumeric():
    return JSONResponse(status_code=422, content={"message": "First Name must be alphanumeric"})

def last_name_not_alphanumeric():
    return JSONResponse(status_code=422, content={"message": "Last Name must be alphanumeric"})
